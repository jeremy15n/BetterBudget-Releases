...
<div align="center">
  ...
  <p>
    ...
    <a href="/VIRUSTOTAL_RESULTS.md"><b>VirusTotal scans</b></a> &nbsp;|&nbsp;
...
- 400 MB disk space
- Valid license key required (purchase at [betterbudgetapp.com](https://betterbudgetapp.com))

## Download

- **Installer:** `BetterBudget Setup X.Y.Z.exe`  
  Installs to **Program Files** and includes auto-update support.

1. Run the installer.

2. You will see a security warning:
   - Click **More info**  
     ![Click More Info](install1.png)
